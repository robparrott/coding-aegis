...
📊 Dependency graph for coding-aegis-b5z (34 issues, 5 layers)
  ...
  │   ├── ○ coding-aegis-b5z.13 ● P1 Restructure test scripts to follow install-then-u…
  │   ├── ○ coding-aegis-b5z.14 ● P1 Claude test: install coding-aegis plugin then use…
  │   ├── ○ coding-aegis-b5z.15 ● P1 Codex test: install coding-aegis skill then use i…
  │   ├── ○ coding-aegis-b5z.16 ● P1 Gemini test: install coding-aegis skill then use …
...
- [`coding-aegis-b5z.13`](phase-2-coding-aegis-skill-claude.md)
- [`coding-aegis-b5z.14`](phase-2-coding-aegis-skill-claude.md)
- [`coding-aegis-b5z.15`](phase-2-coding-aegis-skill-claude.md)
- [`coding-aegis-b5z.16`](phase-2-coding-aegis-skill-claude.md)

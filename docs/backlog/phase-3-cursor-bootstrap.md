...
- [x] `coding-aegis-wpi.14` cursor-agent 2026.04.16 broken: JS bundle crash on every invocation
...
- [x] `coding-aegis-wpi.6` Test Cursor marketplace install flow
- [x] `coding-aegis-wpi.7` Spike: Research non-enterprise remote distribution for Cursor plugins

...
- [ ] `coding-aegis-2sv.1` Spike: Research Windsurf sub-agent and agent swarm capabilities
...
- [ ] `coding-aegis-2sv.6` Windsurf rules delivery
- [ ] `coding-aegis-2sv.7` Copilot instructions delivery

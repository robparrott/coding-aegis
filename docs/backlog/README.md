...
- [ ] [Cross-tool artifact model refactor](cross-tool-artifact-model-refactor.md) — 2/14 tasks
- [ ] [External dependency installation for packages](external-dependency-installation-for-packages.md) — 0/1 tasks
- [ ] [Phase 2: coding-aegis Skill (Claude Code)](phase-2-coding-aegis-skill-claude.md) — 30/33 tasks
...
- [ ] [coding-aegis Skill UX](coding-aegis-skill-ux.md) — 0/4 tasks

## Standalone

- [Standalone issues](standalone.md) — 15 issues

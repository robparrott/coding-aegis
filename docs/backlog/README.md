...
- [ ] [Phase 3: Cursor Bootstrap](phase-3-cursor-bootstrap.md) — 6/10 tasks
...
- [ ] [pytest integration framework for coding-aegis e2e tests](pytest-integration-framework-for-coding-aegis.md) — 5/9 tasks

...
- [ ] [Add OpenCode support](add-opencode-support.md) — 3/6 tasks
...
- [ ] [Phase 3: Cursor Bootstrap](phase-3-cursor-bootstrap.md) — 8/11 tasks
...
- [ ] [pytest integration framework for coding-aegis e2e tests](pytest-integration-framework-for-coding-aegis.md) — 6/10 tasks

## Standalone

- [Standalone issues](standalone.md) — 42 issues

...
- [ ] [Cross-tool artifact model refactor](cross-tool-artifact-model-refactor.md) — 8/15 tasks
...
- [ ] [Phase 7: CI & Validation](phase-7-ci-&-validation.md) — 1/3 tasks
...
- [Standalone issues](standalone.md) — 57 issues

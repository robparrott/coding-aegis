...
- [ ] [Phase 3: Cursor Bootstrap](phase-3-cursor-bootstrap.md) — 9/11 tasks
...
- [ ] [pytest integration framework for coding-aegis e2e tests](pytest-integration-framework-for-coding-aegis.md) — 7/10 tasks
